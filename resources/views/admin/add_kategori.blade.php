...
<div>
    <div class="row">
        ...
        <div class="col-sm-8 offset-sm-2">
            ...
            @endif
                <form action="{{ route('kategori') }}" method="POST" class="my-2" enctype="multipart/form-data">
                    @csrf
                    <div class="container my-2">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Kode</label>
                            <input type="text" class="form-control @if($errors->has('kode')) is-invalid @endif" name="kode" aria-describedby="emailHelp" placeholder="Masukkan Kode">
                            @if ($errors->has('kode'))
