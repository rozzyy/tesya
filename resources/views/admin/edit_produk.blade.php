    ...
    <div class="row">
        ...
        <div class="col-sm-8 offset-sm-2">
            <div class="card">
                ...
                @endif
                <form action="{{ route('edit.produk', ['id' => $produk->id]) }}" method="POST" class="my-2" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="container my-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @if($errors->has('no_produk')) is-invalid @endif" name="no_produk" placeholder="Masukkan Kode" value="{{ $produk->no_produk }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @if($errors->has('nama')) is-invalid @endif" name="nama" aria-describedby="emailHelp" placeholder="Masukkan Nama" value="{{ $produk->nama }}">
                            @if ($errors->has('nama'))
                                <span class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <input type="number" class="form-control @if($errors->has('qty')) is-invalid @endif" name="qty" aria-describedby="emailHelp" placeholder="Masukkan Stok" value="{{ $produk->qty }}">
                                    @if ($errors->has('qty'))
                                        <span class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @if($errors->has('deskripsi')) is-invalid @endif" name="deskripsi" placeholder="Masukkan Deskripsi" rows="4">
                                {{ $produk->deskripsi }}
                            </textarea>
                        ...
                        <div>
                            <img src="{{ $produk->gambar }}" alt="default" class="w-50" id="image">
                        </div>
                    </div>
