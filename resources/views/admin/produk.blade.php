            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row my-2">
                        ...
                        <div class="col-sm-6">
                            <a href="{{ route('buat.produk') }}" class="btn btn-primary float-right" type="button">
...
<script>
    $('#data-table').DataTable({
        ...
        columns: [
            ...
            {"data": 'no_produk', "nama": 'no_produk'},
            {"data": 'nama', "nama": 'nama'},
            {"data": 'qty', "nama": 'stok'},
            {"data": 'harga', "nama": 'harga'},
            {"data": 'action', "name": 'Actions', orderable: false, searchable: false}
        ]
    });
    var produk_id = ''
    $('body').on('click', '#btn-delete', function(e) {
        produk_id = this.value
    ...
    $('#delete').on('click', function(e) {
        ...
        $.ajax({
            type: "DELETE",
            url: "{{ url('/panel/produk') }}".concat('/',id),
            dataType: 'json',
            data: {
                _token: '{{ csrf_token() }}'
            },
