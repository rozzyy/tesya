...
<body>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> hello@kantorcamat.com</li>
                                <li>Tebing Syahbandar - Serdang Bedagai</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            <li class="@if(Route::currentRouteName() === 'home') active @endif"><a href="{{ url('/')}}">Beranda</a></li>
                            <li class="@if(Route::currentRouteName() === 'shop') active @endif"><a href="{{ url('/belanja') }}">Belanja</a></li>
                            {{-- <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="./shop-details.html">Shop Details</a></li>
                                    <li><a href="./shoping-cart.html">Shoping Cart</a></li>
                            ...
                            {{-- <li><a href="./blog.html">Blog</a></li> --}}
                            <li class="@if(Route::currentRouteName() === 'kontak') active @endif"><a href="{{ url('/kontak') }}">Kontak</a></li>
                            <li class="@if(Route::currentRouteName() === 'about') active @endif"><a href="{{ url('/kontak') }}">Tentang Kami</a></li>
                        </ul>
                    </nav>
                </div>
                {{-- <div class="col-lg-3">
    ...
    <!-- Hero Section Begin -->
    <section class="hero @if(Route::currentRouteName() !== 'home') hero-normal @endif">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
